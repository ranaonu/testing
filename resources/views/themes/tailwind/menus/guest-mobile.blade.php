			  ...
			  <ul class="nav-list">
				...
				<li>
				  ...
				  <ul class="nav-dropdown">
					...
					<li>
					  <a href="#!">Change a Delivery</a>
					</li>
				  </ul>
				</li>
				<li>
				  <a href="#!">Service Navigator</a>
				  <ul class="nav-dropdown">
					<li>
					...
					<li>
					  <a href="#!">Pay a Shipment</a>
					</li>
					<li>
					  <a href="#!">Verify a payment</a>
					</li>
					<li>
					  <a href="#!">Discount a shipment</a>
					</li>
					<li>
					  <a href="#!">Billing section</a>
					</li>
				  </ul>
				</li>
				<li>

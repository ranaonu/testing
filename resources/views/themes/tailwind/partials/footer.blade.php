...
<!-- Section 1 -->
<footer class="@if(Request::is('/')){{ 'bg-gray-800' }}@else{{ 'bg-gray-50' }}@endif">
    <div class="px-8 pt-16 mx-auto lg:px-12 xl:px-16 max-w-7xl">
        <div class="flex flex-wrap items-start justify-between pb-20">
            <div class="w-auto font-bold ftr-logo-block">
            <a href="{{ route('wave.home') }}" class="flex items-center  text-lg ">
                @if(Voyager::image(theme('footer_logo')))
                    <img class="h-20" src="/themes/tailwind/images/logo-white.png" alt="Company name">
                @else
            ...
            <p>If your needs are continuous or occasional, whether you import or export to other countries or continents, it is time for Zion Shipping. We specialize in fast, secure and reliable international delivery.</p>
        </div>
            <div class="grid grid-cols-2 pt-2 mt-20 sm:grid-cols-2 gap-y-16 lg:gap-x-8 md:w-3/5 md:mt-0 md:pr-6">
                <div class="md:justify-self-end">
                    <h3 class="font-semibold text-white">Most Popular Links</h3>
                    <ul class="mt-6 space-y-4 text-sm">
                        <li>
                            <a href="#_" class="relative inline-block text-white group">
                                <span class="absolute bottom-0 w-full transition duration-150 ease-out transform -translate-y-1 border-b border-white opacity-0 group-hover:opacity-100 group-hover:translate-y-1"></span>
                                <span>Quote</span>
                            </a>
                        </li>
                        <li>
                ...
                <div class="md:justify-self-end">
                    <h3 class="font-semibold text-white">Business and Connection</h3>
                    <ul class="mt-6 space-y-4 text-sm">
                        <li>
                            <a href="#_" class="relative inline-block text-white group">
                                <span class="absolute bottom-0 w-full transition duration-150 ease-out transform -translate-y-1 border-b border-white opacity-0 group-hover:opacity-100 group-hover:translate-y-1"></span>
                                <span>About Zion Shipping</span>
                            </a>
                        </li>
                        <li>
                            <a href="#_" class="relative inline-block text-white group">
                        ...
                        <li>
                            <a href="{{route('wave.officeSupplies')}}" class="relative inline-block text-white group">
                                <span class="absolute bottom-0 w-full transition duration-150 ease-out transform -translate-y-1 border-b border-white opacity-0 group-hover:opacity-100 group-hover:translate-y-1"></span>
                ...
                <!-- <div class="md:justify-self-end">
                    <h3 class="font-semibold text-black">Connect with Us</h3>
                    <ul class="mt-6 space-y-4 text-sm">
                        <li>
        ...
        <div class="flex flex-col items-center justify-between py-10 border-t border-solid lg:flex-row border-gray">
            <ul class="flex flex-wrap space-x-5 text-xs">
                ...
                <li class="lg:ml-6">
                    <a href="#_" class="relative inline-block text-white group">
                        <span class="absolute bottom-0 w-full transition duration-150 ease-out transform -translate-y-1 border-b border-white opacity-0 group-hover:opacity-100 group-hover:translate-y-0"></span>
            ...
            <ul class="flex items-center mt-10 space-x-5 lg:mt-0 social-links">
                <li>
...
<script src="{{ asset('themes/' . $theme->folder . '/js/bootstrap-select-country.min.js') }}"></script>
<script src="{{ asset('themes/' . $theme->folder . '/js/app.js') }}"></script>
<script src="{{ asset('themes/' . $theme->folder . '/js/msdropdown.js') }}"></script>
<script src="{{ asset('themes/' . $theme->folder . '/js/intlTelInput.js') }}"></script>
...
s1.async=true;
s1.src='https://embed.tawk.to/6260221db0d10b6f3e6e8065/1g13oagmr';
s1.charset='UTF-8';
...
<script type="text/javascript">
    $(document).ready(function(){
        $('.quick-link').click(function(){
            ...
            $('.quick-link').next().removeClass("open");
 ...
 $( ".client-logos-slider .owl-prev").html('<i class="fas fa-chevron-left"></i>');
 $( ".client-logos-slider .owl-next").html('<i class="fas fa-chevron-right"></i>');

<div class="flex flex-wrap w-full mx-auto divide-x divide-gray-100 divide-solid bg-gray-50">
    @foreach(Wave\Plan::all() as $plan)
        @php $features = explode(',', $plan->features); @endphp

        <div class="w-full max-w-md px-0 mx-auto mb-6 lg:w-1/2 lg:mb-0 my-5">
            <div class="relative flex flex-col h-full mb-10 bg-white sm:mb-0">
                ...
                <div class="relative">
                    ...
                    @if(str_contains($plan->plan_id, $subs_id))

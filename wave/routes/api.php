...
Route::post('schedule-pickup', '\Wave\Http\Controllers\ApiController@schedule_pickup')->name('waveAPI.schedulePickup');
Route::post('update-payment', '\Wave\Http\Controllers\ApiController@update_payment')->name('waveAPI.updatePayment');
